...
#include "Galaga_USFX_LAB1/ProyectilEnemigo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGA_USFX_LAB1_API UClass* Z_Construct_UClass_AProyectilEnemigo_NoRegister();
	GALAGA_USFX_LAB1_API UClass* Z_Construct_UClass_AProyectilEnemigo();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ProyectilEnemigoMesh_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ProyectilEnemigoMesh;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProyectilEnemigo_Statics::NewProp_ProyectilEnemigoMesh_MetaData[] = {
		{ "AllowPrivate", "true" },
		{ "Category", "Projectile" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "ProyectilEnemigo.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProyectilEnemigo_Statics::NewProp_ProyectilEnemigoMesh = { "ProyectilEnemigoMesh", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProyectilEnemigo, ProyectilEnemigoMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AProyectilEnemigo_Statics::NewProp_ProyectilEnemigoMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProyectilEnemigo_Statics::NewProp_ProyectilEnemigoMesh_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AProyectilEnemigo_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AProyectilEnemigo_Statics::NewProp_ProyectilEnemigoMesh,
	};
	...
	IMPLEMENT_CLASS(AProyectilEnemigo, 3440072804);
	template<> GALAGA_USFX_LAB1_API UClass* StaticClass<AProyectilEnemigo>()
	{
		return AProyectilEnemigo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AProyectilEnemigo(Z_Construct_UClass_AProyectilEnemigo, &AProyectilEnemigo::StaticClass, TEXT("/Script/Galaga_USFX_LAB1"), TEXT("AProyectilEnemigo"), false, nullptr, nullptr, nullptr);
