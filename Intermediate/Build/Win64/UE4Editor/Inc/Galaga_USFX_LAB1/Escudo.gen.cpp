...
#include "Galaga_USFX_LAB1/Escudo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGA_USFX_LAB1_API UClass* Z_Construct_UClass_AEscudo_NoRegister();
	GALAGA_USFX_LAB1_API UClass* Z_Construct_UClass_AEscudo();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEscudo_Statics::Class_MetaDataParams[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AEscudo_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UconstrucNave_NoRegister, (int32)VTABLE_OFFSET(AEscudo, IconstrucNave), false },
		};
	...
	IMPLEMENT_CLASS(AEscudo, 413819847);
	template<> GALAGA_USFX_LAB1_API UClass* StaticClass<AEscudo>()
	{
		return AEscudo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AEscudo(Z_Construct_UClass_AEscudo, &AEscudo::StaticClass, TEXT("/Script/Galaga_USFX_LAB1"), TEXT("AEscudo"), false, nullptr, nullptr, nullptr);
