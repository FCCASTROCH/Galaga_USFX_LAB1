...
ABall::ABall()
{
	...
	//static ConstructorHelpers::FObjectFinder<UStaticMesh> BallMesh(TEXT("StaticMesh'/Game/Geometry/Meshes/Ball_Extranjera.Ball_Extranjera'"));
	//Segunda forma de crear material
	//static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialBall(TEXT("MaterialInstanceConstant'/Game/TwinStick/Meshes/Ball_Extranjera.Ball_Extranjera'"));
	//Primera forma de crear material
	//static ConstructorHelpers::FObjectFinder<UMaterial> MaterialBall(TEXT("MaterialInstanceConstant'/Game/TwinStick/Meshes/BallMaterial.BallMaterial'"));
